  ...
  <main class="form-signin">
    <form>
      <div class="bg-white border p-5">
        <img class="mb-4" src="<?= IS_DEVELOPMENT ? DEVELOPMENT_BASE_URL : PRODUCTION_BASE_URL ?>assets/logo.png" alt="" width="100">
  ...
  <script>
    ...
    $('.form-signin form').on('submit', e => {
      ...
      if (typeof(Storage) !== "undefined") {
        ...
        $.ajax({
          url: `${IS_DEVELOPMENT ? DEVELOPMENT_BASE_URL: PRODUCTION_BASE_URL}app/database/?request=postAuth`,
          type: 'POST',
          data: {
