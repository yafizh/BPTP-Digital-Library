...
<main>
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="<?= IS_DEVELOPMENT ? DEVELOPMENT_BASE_URL : PRODUCTION_BASE_URL ?>app/admin_page/add_catalog_page.php" class="nav-link active" id="katalog">
                    <svg class="bi me-2" width="16" height="16">
                        <use xlink:href="#grid" />
                    </svg>
                    Katalog
    ...
    const input_form = [
        ...
        `
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="book-isbn" name="book-isbn" value="${editData.book_isbn}">
                </div>
                <div class="col-12">
