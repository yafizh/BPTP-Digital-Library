...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="<?= DEVELOPMENT_BASE_URL ?>admin_page/beranda.php" class="nav-link active" aria-current="page" id="beranda">
    ...
    <div class="d-flex flex-column flex-grow-1 p-3 bg-light">
        ...
        <hr>
        <a href="<?= DEVELOPMENT_BASE_URL ?>home_page.php">Pergi Ke Halaman Pencarian Buku</a>
    </div>
</main>